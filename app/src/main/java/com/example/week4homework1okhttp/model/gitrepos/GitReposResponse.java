...
package com.example.week4homework1okhttp.model.gitrepos;
...
public class GitReposResponse implements Parcelable
{
    ...
    public final static Creator<GitReposResponse> CREATOR = new Creator<GitReposResponse>() {


        @SuppressWarnings({
            "unchecked"
        })
        public GitReposResponse createFromParcel(Parcel in) {
            return new GitReposResponse(in);
        }

        public GitReposResponse[] newArray(int size) {
            return (new GitReposResponse[size]);
        }

    }
    ;

    protected GitReposResponse(Parcel in) {
